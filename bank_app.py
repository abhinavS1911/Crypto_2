...
merchants = {}  # key: merchant name, value: dict with details (mid, password, ifsc_code, initial_balance)
users = {}      # key: username, value: dict with details (uid, mmid, password, mobile_number, upi_pin, initial_balance)
...
class Blockchain:
    ...
    def add_block(self, data):
        ...
        print(f"Block added: {new_block.index} with data: {data}")
        return new_block
...
def handle_client(conn, addr):
    ...
    if req_type == "merchant_registration":
        ...
        if name in merchants:
            ...
            data_block = {"type": "merchant_registration", "name": name, "ifsc_code": ifsc_code,
                          "initial_balance": initial_balance, "mid": mid}
        ...
        if username in users:
            ...
            data_block = {"type": "user_registration", "username": username, "mobile_number": mobile_number,
                          "initial_balance": initial_balance, "uid": uid, "mmid": mmid}
            blockchain.add_block(data_block)
                ...
                if details.get("mmid") == mmid:
                    ...
                    if details.get("upi_pin") != upi_pin:
                        ...
                        if amount > current_balance:
                            ...
                            data_block = {"type": "transaction", "merchant_id": merchant_id, "user_details": user_details}
                            blockchain.add_block(data_block)
